...
## Method
GARCH is the good model to successfully capture the volatility clustreing and predicting future volatilities. The Dynamic Conditional Correlation (DCC-) GARCH belongs to the multivariate GARCH models. <br>
